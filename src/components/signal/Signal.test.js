...
describe("Signal", () => {
  ...
  it("test level 4 - high", () => {
    ...
    expect(levelFive).not.toHaveClass("signal__filled");
    expect(levelFour).toHaveClass("signal__filled");
    expect(levelThree).toHaveClass("signal__filled");
    expect(levelTwo).toHaveClass("signal__filled");
    expect(levelOne).toHaveClass("signal__filled");
  ...
  it("test level 3 - Average", () => {
    ...
    expect(levelFive).not.toHaveClass("signal__filled");
    expect(levelFour).not.toHaveClass("signal__filled");
    expect(levelThree).toHaveClass("signal__filled");
    expect(levelTwo).toHaveClass("signal__filled");
    expect(levelOne).toHaveClass("signal__filled");
  });
  ...
  it("test level 2 - Low", () => {
    ...
    expect(levelFive).not.toHaveClass("signal__filled");
    expect(levelFour).not.toHaveClass("signal__filled");
    expect(levelThree).not.toHaveClass("signal__filled");
    expect(levelTwo).toHaveClass("signal__filled");
    expect(levelOne).toHaveClass("signal__filled");
  });
  ...
  it("test level 1 - Low", () => {
    ...
    expect(levelFour).not.toHaveClass("signal__filled");
    expect(levelThree).not.toHaveClass("signal__filled");
    expect(levelTwo).not.toHaveClass("signal__filled");
    expect(levelOne).toHaveClass("signal__filled");
  });
});
